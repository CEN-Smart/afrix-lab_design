...
export default function Navbar() {
  return (
    <header role='banner'>
      <div className='w-[95%] md:w-[75%] rounded-[32px] bg-black/20 backdrop-blur-[16px] px-4 md:px-16 h-[72px] flex items-center justify-between fixed top-[2rem] lg:top-[6rem] left-1/2 -translate-x-1/2'>
          ...
          <Menu>
            {({ isOpen }) => (
              <>
                ...
                <MenuList bg='rgba(0,0,0,0.1)' color='white'>
                  {navItems.map(navObj => (
                    <MenuItem
                      transition='all'
